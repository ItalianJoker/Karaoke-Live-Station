...
Sovrascrittura GitHub **v1.4.0** (stesso tag; **non** tocca `v1.3.0` / `v1.2.0` / `v1.1.0`). Parte dalla baseline **v1.3.0**. PRs **#52**–**#61**. Pacchetto resta **1.4.0** (nessuna v1.5.0).
...
### 🎵 DSP pitch/speed — Bungee predefinito (#52) + fix udibile (#56) + `_malloc` (#60)
...
### 🎛️ AI strumentale — GPU-First + opzioni (#55) + telemetria onesta (#59/#60)
...
Overwrite of GitHub release **v1.4.0** (same tag; does **not** touch `v1.3.0` / `v1.2.0` / `v1.1.0`). Builds on **v1.3.0** baseline. PRs **#52**–**#61**. Package stays **1.4.0** (no v1.5.0).
...
### 🎵 Pitch/speed DSP — Bungee default (#52) + audible fix (#56) + `_malloc` (#60)
...
### 🎛️ Instrumental AI — GPU-First + options (#55) + honest telemetry (#59/#60)
