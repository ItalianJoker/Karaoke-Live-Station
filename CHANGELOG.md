...
Overwrite of GitHub Release **v1.4.0** after PRs **#52**–**#66** (same version; does **not** touch `v1.3.0` / `v1.2.0` / `v1.1.0`). Builds on `v1.3.0` baseline. Package stays **1.4.0** (no 1.5.0).
