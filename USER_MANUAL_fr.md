...
3. Par défaut un SoundFont GeneralUser GS est inclus ; vous pouvez en sélectionner un personnalisé.
...
- **Drag & Drop :** réordonne les entrées en attente ; le morceau en lecture reste verrouillé en tête.
